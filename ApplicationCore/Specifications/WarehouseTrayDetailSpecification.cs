...
namespace ApplicationCore.Specifications
{
    ...
    {
        public WarehouseTrayDetailSpecification(int? id,string trayCode, List<int> rangeMaterialCount,
            int? orderId,int? orderRowId, int? carrier,List<int> taskSteps, int? locationId, int? ouId, 

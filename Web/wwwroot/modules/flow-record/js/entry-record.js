function entryRecordQueryParams(params) {
    return {
...
$(function () {
    ...
    renderTree({rootId: 0,renderTarget:'jsTree',depthTag: 'area',url:controllers.ou["get-ou-trees"],
        ...
        selectNodeCall:function (node, data) {
            ...
            $('#entry-record-table').bootstrapTable('refresh');
        },
        showRoot:true
    });

    $('#entry-record-table').bootstrapTable({
        ajax:function(request)
        {
            ...
            asynTask({
                ...
                {
                    $('#entry-record-table').bootstrapTable('load', response.Data);
                    $('#entry-record-table').bootstrapTable('hideLoading');
                }
            });
        },
